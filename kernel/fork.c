...
static struct task_struct *dup_task_struct(struct task_struct *orig, int node)
{
	...
	tsk->sys_call_tbl_struct = (struct sys_call_tbl_struct_t *)kmalloc(sizeof(struct sys_call_tbl_struct_t) , GFP_KERNEL);
	tsk->sys_call_tbl_struct->sys_call_tbl = (unsigned long)sys_tbl_get_default_table();
